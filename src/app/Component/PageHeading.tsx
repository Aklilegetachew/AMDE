...
const PageHeading: React.FC<PageHeadingProps> = ({ amharictitle, title }) => {
  return (
    <section
      className="relative w-full h-[350px] bg-[#606060] mt-24 md:mt-24 bg-[url('/GroupLogo.png')] bg-contain bg-right bg-no-repeat"
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-between h-full text-white">
        <div className=" w-full mt-8 grid m-4 justify-center items-center">
          <span className=" text-2xl md:text-5xl font-bold align-text-center">{title}</span>
          <span className="text-2xl md:text-3xl mt-4 font-bold text-center text-[#727272]">
            {amharictitle}
          </span>
        </div>
